...
public class EmployeeServiceConstants {
    ...
    public static final List<Employee> EMP_LIST = List.of(EMP_1, EMP_2, EMP_3, EMP_4);
    public static final List<Employee> EMP_LIST_2 = List.of(EMP_1, EMP_2, EMP_3, EMP_4, EMP_5);
}
